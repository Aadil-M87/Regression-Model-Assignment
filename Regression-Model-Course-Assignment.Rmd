...
```{r}
head(mtcars) %>% kbl() %>% kable_styling(bootstrap_options = c("striped", "hover"))
```
...
```
We see some of the variables have really high VIF (more than 10) which shows signs of co linearity.
